...
public class TelaRegistro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        RegisterTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Long.class, java.lang.Double.class, java.lang.Integer.class
            };
    ...
    private void editarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarButtonActionPerformed
        ...
        if(RegisterTable.getSelectedRow() != -1){
            ...
            registro.setPeso(peso);
            registro.setAltura(altura);
            registro.setIdRegistro((int)RegisterTable.getValueAt(RegisterTable.getSelectedRow(), 0));
    ...
    private void RegisterTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RegisterTableMouseClicked
        if(RegisterTable.getSelectedRow() != -1){
            pesoTextField.setText(RegisterTable.getValueAt(RegisterTable.getSelectedRow(), 2).toString());
            
            alturaTextField.setText(RegisterTable.getValueAt(RegisterTable.getSelectedRow(), 3).toString());
        }
